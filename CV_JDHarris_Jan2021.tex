...
%  \cvitem{
%    \cvheadingstyle{2008 -- 2010}
%}{
%    \cvtitle{Teaching and tutoring}
%    \begin{itemize}[leftmargin=*]
%       	\item teaching assistant -- intro to applied college algebra (fall 2009)
%	\item helping undergraduates with their assignments, mainly in the subjects of calculus and differential equations (from fall 2008 to spring 2010) 
%    \end{itemize}  
%
%}
...
%	(e.g. transportation to/from/on campus, tree removal and replacement, construction/renovation and capital projects on campus)
%	\item  working with other organizations, such as Emory recylces and the office of sustainability to advise on their waste and sustainability initiatives
%	\item current projects include -- mixed-use paths; retro-fitting ultraviolet mesh on windows to decrease bird window strikes; 
    \end{itemize}
...
\> 1510 Clifton Road NE                											\> 301 Thackeray Hall				                 \> 301 Thackeray Hall    \\
